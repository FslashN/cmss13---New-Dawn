...
DEFINE_BITFIELD(flags_ui_actions, list(
	"UI_ACTIONS_HIDDEN" = UI_ACTIONS_HIDDEN,
	"UI_ACTIONS_UNIQUE" = UI_ACTIONS_UNIQUE,
	"UI_ACTIONS_ITEM_CUSTOM" = UI_ACTIONS_ITEM_CUSTOM,
	"UI_ACTIONS_ITEM_GROUP" = UI_ACTIONS_ITEM_GROUP,
))
...
DEFINE_BITFIELD(flags_gun_features, list(
	...
	"GUN_IFF_SYSTEM" = GUN_IFF_SYSTEM,
	"GUN_NO_SAFETY_SWITCH" = GUN_NO_SAFETY_SWITCH,
	"GUN_WY_RESTRICTED" = GUN_WY_RESTRICTED,
	"GUN_SPECIALIST" = GUN_SPECIALIST,
	"GUN_RECOIL_BUILDUP" = GUN_RECOIL_BUILDUP,
	"GUN_IS_SILENCED" = GUN_IS_SILENCED,
	"GUN_WIELDED_FIRING_ONLY" = GUN_WIELDED_FIRING_ONLY,
	"GUN_ONE_HAND_WIELDED" = GUN_ONE_HAND_WIELDED,
	"GUN_ATTACHED_FIRE_ONLY" = GUN_ATTACHED_FIRE_ONLY,
	"GUN_ATTACHMENT" = GUN_ATTACHMENT,
	"GUN_ANTIQUE" = GUN_ANTIQUE,
	"GUN_SUPPORT_PLATFORM" = GUN_SUPPORT_PLATFORM,
	"GUN_NO_DESCRIPTION" = GUN_NO_DESCRIPTION,
))

DEFINE_BITFIELD(flags_gun_toggles, list(
	"GUN_UNABLE_TO_FIRE" = GUN_UNABLE_TO_FIRE,
	"GUN_BURST_FIRING" = GUN_BURST_FIRING,
	"GUN_FLASHLIGHT_ON" = GUN_FLASHLIGHT_ON,
	"GUN_AUTO_EJECTING_ON" = GUN_AUTO_EJECTING_OFF,
	"GUN_AUTO_EJECTING_TO_HAND" = GUN_AUTO_EJECTING_TO_HAND,
	"GUN_TRIGGER_SAFETY_ON" = GUN_TRIGGER_SAFETY_ON,
	"GUN_IFF_SYSTEM_ON" = GUN_IFF_SYSTEM_ON,
	"GUN_RECOIL_COMP_ON" = GUN_RECOIL_COMP_ON,
	"GUN_ACCURACY_ASSIST_ON" = GUN_ACCURACY_ASSIST_ON,
	"GUN_AUTOMATIC_AIM_ASSIST_ON" = GUN_AUTOMATIC_AIM_ASSIST_ON,
	"GUN_SECONDARY_MODE_ON" = GUN_SECONDARY_MODE_ON,
	"GUN_MOTION_DETECTOR_ON" = GUN_MOTION_DETECTOR_ON,
	"GUN_ID_LOCK_ON" = GUN_ID_LOCK_ON,
	"GUN_PLAYING_RUS_ROULETTE" = GUN_PLAYING_RUS_ROULETTE,
	"GUN_ATTACHED_TO_PARENT" = GUN_ATTACHED_TO_PARENT,
))

DEFINE_BITFIELD(flags_gun_receiver, list(
	"GUN_INTERNAL_MAG" = GUN_INTERNAL_MAG,
	"GUN_CHAMBERED_CYCLE" = GUN_CHAMBERED_CYCLE,
	"GUN_MANUAL_CYCLE" = GUN_MANUAL_CYCLE,
	"GUN_CHAMBER_CAN_OPEN" = GUN_CHAMBER_CAN_OPEN,
	"GUN_CHAMBER_IS_OPEN" = GUN_CHAMBER_IS_OPEN,
	"GUN_CHAMBER_ROTATES" = GUN_CHAMBER_ROTATES,
	"GUN_CHAMBER_IS_STATIC" = GUN_CHAMBER_IS_STATIC,
	"GUN_CHAMBER_HAS_EMPTY_CASING" = GUN_CHAMBER_HAS_EMPTY_CASING,
	"GUN_ACCEPTS_SPEEDLOADER" = GUN_ACCEPTS_SPEEDLOADER,
	"GUN_ACCEPTS_HANDFUL" = GUN_ACCEPTS_HANDFUL,
	"GUN_CHAMBER_IS_JAMMED" = GUN_CHAMBER_IS_JAMMED,
	"GUN_HAMMER_IS_COCKED" = GUN_HAMMER_IS_COCKED,
	"GUN_CHAMBER_BELT_FED" = GUN_CHAMBER_BELT_FED,
))

DEFINE_BITFIELD(gun_category, list(
	"GUN_CATEGORY_HANDGUN" = GUN_CATEGORY_HANDGUN,
	"GUN_CATEGORY_SMG" = GUN_CATEGORY_SMG,
	"GUN_CATEGORY_RIFLE" = GUN_CATEGORY_RIFLE,
	"GUN_CATEGORY_SHOTGUN " = GUN_CATEGORY_SHOTGUN,
	"GUN_CATEGORY_HEAVY" = GUN_CATEGORY_HEAVY,
))

DEFINE_BITFIELD(flags_attach_features, list(
	"ATTACH_INTEGRATED" =  ATTACH_INTEGRATED,
	...
	"ATTACH_SKIN_SELECTION" = ATTACH_SKIN_SELECTION,
))
...
DEFINE_BITFIELD(flags_magazine, list(
	...
	"AMMUNITION_IN_VIS_CONTENTS" = AMMUNITION_IN_VIS_CONTENTS,
))
